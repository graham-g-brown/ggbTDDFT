...
if platform == "darwin":
    ...
    file_path = "/home/graham/Dropbox/Graham/Data0/Simulations/"
...
if __name__ == "__main__":
    ...
    if filename[-3:] != ".py":
        ...
        input_file = file_path + "ggbSPH4/output/" + filename + ".cuh"
    else:
        module_name = filename[:-3]
        input_file = file_path + "ggbSPH4/output/" + module_name + ".cuh"
else:
